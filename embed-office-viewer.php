...
<?php if (($doc_ext == 'pdf' || $doc_ext == 'html') && $view_type == 'microsoft') {
...
<p><a style="margin-bottom: 10px;" download href="<?php echo $doc_file; ?>"><button
...
<div style="position:relative">
    ...
    <div id="wrapper" style="position: relative;">
        ...
        <iframe src="<?php echo $url; ?>" width="<?php echo $width; ?>" height="<?php echo $height; ?>"
        ...
        <iframe src="<?php echo $eov_onedrive_document; ?>" width="<?php echo $width; ?>"
            height="<?php echo $height; ?>" frameborder="0" scrolling="no"></iframe>

        <?Php } elseif ($document_source == 'dropbox') {?>
        <div style="display: inline-block">
            <a href="<?php echo $dropbox_doc_file; ?>" class="dropbox-embed" data-height="<?php echo $height; ?>px"
                data-width="<?php echo $width ?>px"></a>
        </div>
        <?php }?>
...
function eov_admin_assets($screen)
{
    ...
    if ((!empty($post) && $post->post_type == 'officeviewer') || 'officeviewer_page_eov-onedrive' == $screen) {
        wp_enqueue_script('eov-admin-js', plugin_dir_url(__FILE__) . 'admin/js/script.js', array('jquery', 'dropboxjs', 'eov-microsoft-js'), '');
        // OneDrive Picker
        wp_enqueue_script('eov-microsoft-js', 'https://js.live.net/v7.2/OneDrive.js');
        // Google Picker
        wp_enqueue_script('eov-google-js', plugin_dir_url(__FILE__) . 'admin/js/google.js', array('eov-google-picker-js'), null, true);
