    ...
    $(document).ready(function () {
        ...
        if (eov.plugin == 'pro') {
            ...
            if (eov.client_id == '') {
                ...
                $("[value='onedrive']").parent().on('click', function () {
            ...
            if (eov.dropbox_appkey == '') {
                ...
                $("[value='dropbox']").parent().on('click', function () {
                    this.prop('disabled', true);
                });
            }
            if (eov.g_apikey == '' || eov.g_client_id == '' || eov.project_number == '') {
                ...
                $("[value='google']").parent().on('click', function () {
                    this.prop('disabled', true);
                });
            }
        } else {
        ...
        $("<div id='google_empty_alert'><div class='alert_text'><span>×</span><p>Please, Configure Google API From <a target='_blank' href='" + website + "/wp-admin/edit.php?post_type=officeviewer&page=eov-onedrive'>Cloud API Settings</a></p><div class='g_footer'><a href='#' class='g_ok button button-primary'>OK</a></div></div><div class='google_alert_overlay'></div></div>").insertAfter("#eov_google_picker");
